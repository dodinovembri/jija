          ...
          <div class="box-body">
            ...
            <div class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label">Post To Facebook</label>
                <div class="col-sm-8">
                 <html>
                  <head>
                    ...
                    <meta property="og:url"           content="<?php echo base_url('products/'.$dt_users->id) ?>" />
                    <meta property="og:type"          content="website" />
                    <meta property="og:title"         content="<?= $dt_users->nama_product; ?>" />
                    <meta property="og:description"   content="<?= $dt_users->nama_product; ?>" />
                    <meta property="og:image"         content="<?= $dt_users->gambar_product; ?>" />
                  </head>
                  <body>
                    ...
                    <div class="fb-share-button" 
                      data-href="<?php echo base_url('products/'.$dt_users->id) ?>" 
