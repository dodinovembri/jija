      ...
      <div class="col-sm-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Table: About</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <table id="usersTable" class="table table-bordered table-striped dataTable">
                    ...
                    {
                      echo '<tr>' .PHP_EOL;
                        echo '<td><img src='.base_url("assets/public/uploads/").$dt['image'].' width="150" height="150" /></td>' .PHP_EOL;
                        echo '<td>'.$dt['title_image'].'</td>' .PHP_EOL;
                        echo '<td>'.$dt['sub_title_image'].'</td>' .PHP_EOL;
                        echo '<td>'.$dt['company_name'].'</td>' .PHP_EOL;
