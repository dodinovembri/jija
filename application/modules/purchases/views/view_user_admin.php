          ...
          <div class="box-body">
            ...
            <div class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input name="nama_depan" class="form-control" id="input-username" placeholder="Nama Depan" type="text" value="<?php echo $dt_users->nama_depan; ?>">
                </div>
                <div class="col-sm-1">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input name="nama_belakang" class="form-control" id="input-username" placeholder="Nama Belakang" type="text" value="<?php echo $dt_users->nama_belakang; ?>">
                </div>
                <div class="col-sm-1">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input name="subyek" class="form-control" id="input-username" placeholder="Subyek" type="text" value="<?php echo $dt_users->subyek; ?>">
                </div>
                <div class="col-sm-1">
