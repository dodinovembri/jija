        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="col-sm-6">
              ...
              <a class="btn btn-app" href="<?php echo site_url('admin/services/edit/'.$dt_users->id); ?>">
                <i class="fa fa-rotate-left"></i> Undo
              </a>
            </div>
            <div class="col-sm-6">
              <a class="btn btn-app pull-right bg-maroon" href="<?php echo site_url('admin/services/update/'.$dt_users->id); ?>">
