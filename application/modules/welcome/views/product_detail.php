      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center">
            ...
            <h2 class="section-title mb-3">Our Product</h2>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-6 mb-5">
              <div class="product-item">
                <figure>
                  <img src="<?php echo base_url('assets/public/uploads/') ?><?= $product->gambar_product ?>" alt="Image" class="img-fluid">
                </figure>
                <div class="px-4">
                  <h3><a href="#"><?= $product->nama_product; ?></a></h3>
                  <div class="mb-3">
                  ...
                  <p class="mb-4"><?= $product->ket_product; ?></p>
                  <div>
                    <a href="<?php echo base_url('/#purchase-section') ?>" class="btn btn-black mr-1 rounded-0">BUY</a>
                  </div>
                </div>
              </div>
            </div>         
